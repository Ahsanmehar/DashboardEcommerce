...
function AddProduct() {
  ...
  localStorage.setItem("pro", JSON.stringify(formData));
  ...
  function handleImage(e) {
    ...
    const newImages = file.map((file) => file);
        ...
        <div className="w-[49.5%] h-[100%] bg-secondary p-[16px] border-[1px] border-border rounded-[9px] flex flex-col gap-[20px]">
          ...
          <div className="flex justify-between w-[100%] h-[25vh] bg-pink-00">
            {images.map((image, index) => (
              <>
                <div
                  className="w-[32%] h-full border-[1px] border-border rounded-[8px]"
                  key={index}
                >
          ...
          <div className="flex gap-[15px]">
            <button className="py-[15px] px-[22px] bg-blue text-white rounded-[8px]">
              Add Product
            </button>
            <button className="py-[15px] px-[22px] bg-white text-blue rounded-[8px]">
              Save Product
            </button>
            <button className="py-[15px] px-[22px] bg-white text-black rounded-[8px]">
              Schedule
            </button>
          </div>
        </div>
